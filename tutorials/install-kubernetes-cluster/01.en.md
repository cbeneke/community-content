...
*This tutorial was tested on Ubuntu 18.04 Hetzner Cloud servers and Kubernetes version v1.18.3*

*Ubuntu 20.04 is known to create problems when using flannel CNI, either stick to 18.04 or choose another CNI as described in Step 3.2*
...
> When using Ubuntu 20.04 please follow the [official Hetzner guidelines](https://wiki.hetzner.de/index.php/Cloud_floating_IP_persistent/en#Ubuntu_20.04:) and adapt to your needs. *This was not tested as part of writing this tutorial*
